...
shopBlock.addEventListener("click", async (e) => {
  ...
  if (e.target.classList.contains("add-to-cart")) {
    ...
    let itemOrigin = e.target.parentNode.querySelector(".bean-listing-origin")
      .dataset.origin;
    let itemPrice = e.target.parentNode.querySelector(".bean-listing-price")
      .dataset.price;
    let itemHTML = `
        <div class="cart-item">
...
orderForm.addEventListener("submit", (e) => {
  e.preventDefault();
  fetch("https://good-omens-coffee.herokuapp.com/orders", {
    method: "POST",
    headers: {
